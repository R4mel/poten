...
export const products: Product[] = [
  {
    ...
    originalPrice: 9900,
    discount: 20,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "소고기 미역국" }],
    category: "국/탕/찌개",
    description:
  ...
  },
  {
    ...
    name: "[집밥의완성] 된장찌개",
    price: 6900,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "된장찌개" }],
    category: "국/탕/찌개",
  ...
  },
  {
    ...
    originalPrice: 15900,
    discount: 19,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "소불고기" }],
    category: "메인요리",
  ...
  },
  {
    ...
    name: "[집밥의완성] 갈비찜",
    price: 19900,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "갈비찜" }],
    category: "메인요리",
  ...
  },
  {
    ...
    originalPrice: 10900,
    discount: 18,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "오징어볶음" }],
    category: "반찬",
    description:
  ...
  },
  {
    ...
    originalPrice: 9900,
    discount: 20,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "김치찌개" }],
    category: "국/탕/찌개",
    description:
  ...
  },
  {
    ...
    originalPrice: 12900,
    discount: 23,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "제육볶음" }],
    category: "메인요리",
    description:
  ...
  },
  {
    ...
    originalPrice: 5900,
    discount: 17,
    images: [{ url: "/placeholder.svg?height=300&width=300", alt: "시금치나물" }],
    category: "반찬",
